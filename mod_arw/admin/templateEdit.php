...
if($_POST['update'] == 'Update'){
	...
	$qry = $wpdb->update('template',array('template_name'=>$template_name, 'template_description'=>$template_description, 'template_content'=>$template_content, 'date_created'=>$date_created),array('template_id'=>$_GET['temp_id']) );
...
if($_POST['submit'] == 'Submit'){
		...
		$true_msg = 'Variable added successfully';
		}
	}
?>
...
<div class="wrap">
	...
	<h3> Manage Template <span style="float:right;"><a href="admin.php?page=arWizardAllTemplate&sequence_id=<?php echo $_GET['sequence_id'];?>">&laquo; Back to List</a></span></h3>
...
<?php
	...
	$sql = "select * from template where template_id='".$_GET['temp_id']."'";
	$row=$wpdb->get_row("select * from template where template_id='".$_GET['temp_id']."'");
...
?>
          ...
          <?php
		  	if($error == '1')
				{
		  ?>
          <div class="error" style="padding: 20px 0 0 20px;"><?php echo "<span style='color:red;'>$error_template_name"."<br>"."$error_template_content</span>"?></div>
          <?php
		  		}
			...
			if($true_msg)
				{
		  ?>
          <div class="true" style="padding: 20px 0 0 20px;"><?php echo "<span style='color:red; padding-top:20px;'>$true_msg</span>"?></div>		  
          <?php
		  		}
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <form method="post" action="" name="template_form" class="form" id="template_form">
						...
						<div class="field">
                            ...
                            <input type="text" name="template_name" size="40" value="<?php echo $row->template_name;?>">
                        </div>
						
						<div class="field">
                        	<label>Template Description</label>
                            <input type="text" name="template_description" size="40" value="<?php echo $row->template_description;?>">
                        </div>
						
						<div class="field">
                        	<label>Template Content</label>
                            <textarea name="template_content" rows="20" cols="60"><?php echo $row->template_content;?></textarea>
                        </div>
						<div class="field">
